...
@ConfigurationParameter(key = Constants.PLUGIN_PROPERTY_NAME,value = "pretty, json:target/json-report/CucumberReportJson.json")


public class RunnerTopluJasonReport {
    /*
