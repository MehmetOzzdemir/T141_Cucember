...
public class WebUniversityStepdefinitions {
    ...
    public void login_portal_a_kadar_asagi_iner() {
        ...
        jse.executeScript("arguments[0].scrollIntoView({block: 'center'});",webUniversityPage.loginPortalButton);
    }
    ...
    public void popup_ta_cikan_yazinin_oldugunu_test_eder(String expectedPopupStr) {
        String actualPopupStr = Driver.getDriver().switchTo().alert().getText();
        Assertions.assertEquals(expectedPopupStr,actualPopupStr);
